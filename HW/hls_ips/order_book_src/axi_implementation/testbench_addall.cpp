...
int main()
{
    ...
    hls::stream<axis_bit_t >   publish_order("inAlgo");
...
//                    Orderbook_wrapper(inStream_pars, publish_order, outStream_algo);
//                }
//            }
//        }
